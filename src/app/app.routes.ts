...
export const routes: Routes = [
    {
        path: "admin", component:LayoutComponent,canActivate: [authGuard],data: { [Roles.ADMIN]: true } ,children:[
          ...
          { path: "carousel/carousel-update/:id", loadComponent: () => import('./admin/components/carousel/carousel-update/carousel-update.component').then(m => m.CarouselUpdateComponent), canActivate: [authGuard],data: { [Roles.ADMIN]: true } },
      ...
      { path: "privacy-policy", loadComponent: () => import('./dialogs/privacy/privacy-policy/privacy-policy.component').then(m => m.PrivacyPolicyComponent) },
      { path: "terms-of-use", loadComponent: () => import('./dialogs/privacy/terms-of-use/terms-of-use.component').then(m => m.TermsOfUseComponent) },
